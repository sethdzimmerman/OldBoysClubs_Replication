...
PROJECT_PATH = '../../../../'
CR_MASTER = PROJECT_PATH + 'Intermediate Data/Excel Files/updated_class_reports/all_years.csv'
RB_MASTER = PROJECT_PATH + 'Intermediate Data/Excel Files/redbooks_master.csv'
TRAINING_DATA = PROJECT_PATH + 'Code/Main/Python/red_book_class_report_linking/training_data_new.csv'
CLASSIFIER = PROJECT_PATH + 'Code/Main/Python/red_book_class_report_linking/classifier.joblib'
N_FOLDS = 10
