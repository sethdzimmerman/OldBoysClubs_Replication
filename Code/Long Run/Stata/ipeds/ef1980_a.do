...
insheet using "`indir'/ef1980_a_data_stata.csv", comma clear
label data "dct_ef1980_a"
...
label define label_line 14 "Total full-time students (sum of 1, 7, 10 and 11)", add 
...
label define label_line 28 "Total part-time students (sum of 15, 21, 24 and 25)", add 
...
compress
save "`outdir'/dct_ef1980_a.dta" , replace
