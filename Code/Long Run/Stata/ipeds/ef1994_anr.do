...
insheet using "`indir'/ef1994_anr_data_stata.csv", comma clear
label data "dct_ef1994_anr"
...
cap label define label_lstudy D "Total postbaccalaureate, EF1", add 
...
summarize bal_m
summarize bal_w
save "`outdir'/dct_ef1994_anr.dta", replace
