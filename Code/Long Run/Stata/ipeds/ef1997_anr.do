...
insheet using "`indir'/ef97_anr_data_stata.csv", comma clear
label data "dct_ef97_anr"
...
cap label define label_line 1 "Full-time undergraduate degree-seeking 1st-time freshmen" 
...
cap label define label_line 15 "Part-time undergraduate degree-seeking 1st-time freshmen", add 
cap label define label_line 16 "Part-time undergraduate degree-seeking other 1st year", add 
...
cap label define label_line 19 "Part-time undergraduate degree-seeking 4th year and beyond", add 
cap label define label_line 2 "Full-time undergraduate degree-seeking other 1st year", add 
cap label define label_line 20 "Part-time undergraduate degree-seeking unclassified by level", add 
...
cap label define label_line 5 "Full-time undergraduate degree-seeking 4th year and beyond", add 
cap label define label_line 6 "Full-time undergraduate degree-seeking unclassified by level", add 
...
summarize balmen
summarize balwomen
save "`outdir'/dct_ef1997_anr.dta" , replace
