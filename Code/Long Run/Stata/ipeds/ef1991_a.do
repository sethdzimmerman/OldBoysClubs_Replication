...
local indir = "`1'"
 local outdir = "`2'"                                           
insheet using "`indir'/ef1991_a_data_stata.csv", comma clear
...
cap label define label_line 13 "Full-time other graduates enrolled in credit courses", add 
...
cap label define label_line 20 "Part-time undergraduates, degree seeking unclassified", add 
cap label define label_line 21 "Part-time other undergraduates enrolled in credit courses.", add 
...
cap label define label_line 27 "Part-time other graduates enrolled in credit courses", add 
...
cap label define label_line 6 "Full-time undergraduates, degree seeking unclassified", add 
cap label define label_line 7 "Full-time other undergraduates enrolled in credit courses.", add 
...
cap label define label_lstudy D "Total post Bacaalaureate", add 
//label values lstudy label_lstudy
cap label define label_section 1 "FT" 
cap label define label_section 2 "PT", add 
...
summarize bal_w
compress
save "`outdir'/dct_ef1991_a.dta" , replace
