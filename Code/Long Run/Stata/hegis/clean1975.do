...
local dir = "$hegis_raw_data/ICPSR_02063/DS0001"
global icpst_dict "$hegis_raw_data/02063-0001-Setup.dct"
local data = "`dir'" + "/" + "02063-0001-Data.txt"
di "`data'"
...
cap label data "Higher Education General Information Survey (HEGIS) VIII: Opening Fall Enrollment in Higher Education, 1975, Dataset 0001"
...
drop PARTAB6 PARTAB7 PARTAB8 PART1367 PARTOT PARTFUL SURVEYIN
...
qui compress
save "$hegis_in_data/hegis1975.dta" , replace
