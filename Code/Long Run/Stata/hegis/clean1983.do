...
label data "Higher Education General Information Survey (HEGIS) XVI: Fall Enrollment, 1983, Dataset 0001"
...
drop TOT* MODLINE NRES* BLK* AIA* ASN* HIS* WHTN* IMPUTCID CYUPDATE RESTRIC
reshape wide enroll* , i(FICE) j(j) string

qui compress
save "$hegis_in_data/hegis1983.dta" , replace
