...
quietly {
isid FICE LINECOD PARTCOD // this variable now supplants DISCIPID
keep if PARTCOD == "Z" // totals across disciplines
...
* labels
cap label data "Higher Education General Information Survey (HEGIS) VIII: Opening Fall Enrollment in Higher Education, `year', Dataset 0001"
